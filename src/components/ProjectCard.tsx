...
export function ProjectCard({theme, descripcion, logoClaro, logoOscuro, onClick}: {theme: string, descripcion: string, logoClaro: string, logoOscuro: string, onClick: () => void}) {
    return(
        <article className="flex flex-col group  w-full max-w-2xl mx-auto shadow-[0_0_25px_0px_#CCD5AE] dark:shadow-[0_0_0px_0px_#CCD5AE] dark:bg-[#161616] p-10 rounded-4xl
            ...
            <img alt="Logo StayIn" src={theme==='light' ? logoClaro : logoOscuro} className="object-cover w-full h-full transition-transform duration-500 group-hover:scale-105"></img>
